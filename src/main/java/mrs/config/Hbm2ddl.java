...
public class Hbm2ddl {
    ...
    public static void main(String[] args) throws Exception {
        String locationPattern = "classpath:mrs/domain/model/*";
        ...
        final PathMatchingResourcePatternResolver resourcePatternResoulver = new PathMatchingResourcePatternResolver();
        final Resource[] resources = resourcePatternResoulver.getResources(locationPattern);
